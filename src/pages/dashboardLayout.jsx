...
class DashboardLayout extends React.Component {
  ...
  userProfileDropdown() {
    ...
    let userImage = ((getPhotoUrl() && getPhotoUrl() != null && getPhotoUrl() != undefined && getPhotoUrl() != 'null' && !this.props.userState.userPhotoUpdate) ? getPhotoUrl() : AppImages.defaultUser)
