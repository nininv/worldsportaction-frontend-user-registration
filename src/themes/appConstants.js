const AppConstants = {
    ...
    haveDisability:
        "Do you qualify for NDIS (National Disability Insurance Scheme)?",
    ...
    // export URl
    exportUrl:
        "http://world-sport-action-socket.appspot.com/players/csv?competitionId=",
    ...
    inviteIndividualTeamMember:
        "Invite Individual Team Members to Register and pay their portion of the Team Registration Fee",
    registerOnBehalf:
        "Register on behalf of the Team and pay the entire Team Registration Fee",
    ...
    emailValidationInfo:
        "Updating the email address will update the login information(User Name) while submitting this form. Please ensure that the information provided is correct.",
    stateHeading: "State",
    ...
    playerImpMsg:
        "Import will remove existing Team Members from the list and populate the new Team Members based on the data available in the Template.",
  ...
  above.`,
    ...
    allMatches: "Full Competition - Upfront",
    weeklyInstalment: "Full Competition - Instalment",
    ...
    webAdmin: "WebAdmin",
    teamAlreadyExists:
        "This team name is already in use. Please choose an alternative name.",
    singleCompetition: "Single Competition",
    registrationCode: "Registration Code",
    ok: "Ok",
    useSameEmailAsParent: "Use same email as parent",
    stateMismatchTitleMessage: "Warning",
    stateMismatchModelMessage:
        "You can only register for one state at a time. Your other selections will be cleared if you want to select a different state. Do you want to proceed?",
    CASUAL_FEE: 1,
    SEASONAL_FEE: 2,
  ...
  choosing a donation option below.`,
    ...
    secondReportFormStepQ3:
        "What happened that made you lodge this refereeReport?",
    ...
    thirdReportFormStepQ1:
        "Is there anything that you would like to add that may assist in assessing these charges?",
  ...
  to show your pride and passion.`,
    ...
    injury:
        "Please list any injury which is current or recurring or requires surgery? ",
    ...
    playingOtherParticipantSports:
        "Are you playing any other participation sport?",
    childPlayingOtherParticipantSports:
        "Is your child playing any other participation sport?",
    someOnePlayingOtherParticipantSports:
        "Are other playing any other participation sport?",
    ...
    participatedSchoolProgram:
        "Have you participated in the Sporting School Program?",
    ...
    workingWithChildrenCheckNumber:
        "What is your Working with Children Check Number or BlueCard Number? You are required to have a Working with Children Check Number or BlueCard. If you don't you will need to apply for one.",
    haveCompletedPrerequisites:
        "Have you completed the prerequisites for a training Umpire?",
    ...
    childMsg2Parent:
        "You have elected to use the same email for your Child and yourself. Your child will not get their own login. If you would like them to have their own login please give them a separate email address.",
    parentMsg2Child:
        "You have elected to use the same email for your Parent and yourself. You will lose your login unless you update your own email address first. If you do go ahead with using the same email address, you will be logged out for security reasons, and need to log in again.",
    returnToSelectAddress: "Return to select address",
    returnToLogin: "Return to Login",
    yourDetails: "Your Details",
    selectFromParticipantAndParentDetails:
        "Select from Participant and Parent Details",
    addNewDetails: "Add new Details",
    pickupAddress: "Pickup Address",
    deliveryTypePickup: 'pickup',
  deliveryTypeShipping: 'shipping',
  pickupDescription: 'Pick-up',
  shippingDescription: 'Delivery',qty: "Qty",
    securePaymentMsg: "There is no payment required",
    submitButtonPressDescription:
    ...
    anyExistingMedicalCondition:
        "Please detail any existing medical conditions, allergies (medical or food) or Illnesses. Please detail a Management Plan (if applicable)",
    ...
    teamRegistrationNote:
        "Please note, your Team Members may be required to login and complete their registration by paying their Membership (if applicable) fees. Some team members may have already paid their membership fees.",
    ...
    ifAllTeamMemberHaveNotRegistered:
        "If all Team Members have not registered by the Competition start date, you will be charged any outstanding monies and it will be your responsibility to recoup that from your team members.",
    ...
    noCompetitionsForOrganisations:
        "There are no open competitions for this organisation",
    ...
    payCompetitionAndNominationFeesForAll:
        "Pay Competition Fees and Nomination Fees (if Applicable) for All",
    ...
    registeringIndividualTo:
        "Membership Product you are registering Individual to",
    ...
    successProfileUpdateMessage:
        "You have successfully updated your profile for this Registration.",
    exit: "Exit",
    profile: "Profile",
    ...
    id: "ID",
    // CM-2026
    banIndividualTeamMixRegistrationMessage:
        "Team Registrations cannot be completed at the same time as Individual registrations. Please complete your current Individual Registration and then log back in to complete the Team Registration.",
    childUnlinkMessage:
    ...
    _sms: "SMS",
    sameEmailValidationMessage:
        "You have elected to use the same email for your child and yourself. Your child will not get their own login. If you would like them to have their own login please give them a seperate email address.",
    sameSomeoneEmailValidationMessage2:
        "You have elected to use the same email for the child and the parent/ guardian. The child will not get their own login. If you would like them to have their own login please give them a seperate email address.",
    sameSomeoneEmailValidationMessage:
        "A different email address is required for you and the user you are registering.",
    // found matched user to continue registration
    oneUserAlreadyExists:
        "We have found a matching user with email: {{email}} and mobile number {{phone}}. In order to verify your identity, we will send you an authentication code via",
    manyUsersAlreadyExists:
        "We have found a few possible users that match the details you've entered. Please select the user that matches your details (for security reasons, we have masked some of the details) and then confirm if you would like to recieve your authentication code at the email address or mobile number we have found. If you don't find any matching contact details, please contact your competition organiser or club admin",
    userAlreadyExistsNoContact:
        "We have found a matching user but your details don’t match. Please contact your competition organiser.",
    enterXDigitCode: "Enter {{number}} digit code",
    confirmDetails: "Please enter the complete {{detail}}",
    declineConfirmDetails:
        "Sorry, the details you’ve entered do not match the details we have on record.",
    ...
    please_sel_umpire_unavailable_time:
        "Please select the dates/times you are unavailable to umpire and click Save.",
    oneMatchOnlyTipMsg:
        "For those wanting to play a single match in this competition",

    allMatchesTipMsg:
        "For those who want to play the entire competition and pay fees now",
    userLoginEmailChangeMessage: "This will change the user’s login",
    pleaseReview:
        "Please review this page and correct any errors before submitting again",
    umpireAccreditation: "Umpire Accreditation",
    expiry: "Expiry",
    instalmentTipMessage:
        "For those who want to play the entire competition and pay fees by Instalment",
    ...
    umpireAvailabilityMessage:
        "Please complete your Umpiring Availability and enter your Bank Account details (for Umpire Payments) by clicking on the Action menu.",
    outOfStock: "Out of stock",

    // not found or empty values
    regoDivisionNotFound:
        "No Divisions match your User information, please choose another Competition.", // CM-2064
    ...
    noPickupMessage:
        "There is no pick up or delivery applicable to this product.",
    ...
    warningUseSessionEmailAsParentAddress:
        "Your child is already logged in as the primary contact for your email address. Please log out and complete the registration so that we can correct the email address relationship as part of the registration process.",
    cardValidationMsg:
        "Going forward this card will default as your payment for all future payments",
