                ...
                if(action.key == "organisationUniqueKey"){
                    ...
                    let divisions = participant.competitionInfo.membershipProducts.find(x=>x.competitionMembershipProductTypeId == 
                        ...
                        if(divisions!= null && divisions!= undefined && divisions.length > 0)
                        {
                            ...
                            if(memProd.allowTeamRegistrationTypeRefId == 2){
                                participant["team"]["registrationTypeId"] = 3;
                            }
                            else{
           ...
           // console.log("XXXXX", x);
            if(x.competitionTypeDiscountId!= null)
            {
                ...
                if(isNullOrUndefined(discount)){
                    if(isNullOrUndefined(memProd.fees.competitionOrganisorFee) && memProd.fees.competitionOrganisorFee.organisationId == discount.organisationId)
                    {
                ...
                if(isNullOrUndefined(discount)){
                    if(isNullOrUndefined(memProd.fees.membershipFee) && memProd.fees.membershipFee.organisationId == discount.organisationId)
                    {
